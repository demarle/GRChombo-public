...
#ifndef APPARENT_HORIZON_TESTLEVEL_HPP_
#define APPARENT_HORIZON_TESTLEVEL_HPP_
...
class ApparentHorizonTestLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<ApparentHorizonTestLevel>;
    ...
    virtual void initialData()
    {
        ...
        */
        ...
        // First set everything to zero then calculate initial data  Get the
        // Kerr solution in the variables, then calculate the \tilde\Gamma^i
...
#endif /* APPARENT_HORIZON_TESTLEVEL_HPP_ */
